    ...
    <Grid.Row style={{ maxWidth: 800 }}>
        ...
        <a href="https://migdelinabuelna.github.io/GAMBLER/">
            <Card fluid link>
                ...
                <Card.Content>
                    <Card.Description>
                        <p><p>Gambler is a slot machine game that you initiate by clicking the "BET" button. Once the button is clicked the screen will randomly display three images. If three of the same images appear on the screen, you win the game! Otherwise, you loose, but you get to try again for as many rounds as you'd like.</p></p>
                    </Card.Description>
                 </Card.Content>
            </Card>
            </a>
